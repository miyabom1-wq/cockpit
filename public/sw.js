const CACHE='vantage-v54-provider-resilience-20260724';
const SHELL=['./vantage-frame-sync-v49.js','./reliability-fixes-v53.js','./reliability-fixes-v54.js','./manifest.json','./icon-v45-192.png','./icon-v45-512.png','./icon-v45-maskable-192.png','./icon-v45-maskable-512.png','./icon-badge.png','./apple-touch-icon-v45.png'];
