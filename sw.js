const CACHE='vantage-refined-condition-board-20260712';
...
self.addEventListener('push',e=>{
  ...
  e.waitUntil(self.registration.showNotification(d.title||'VANTAGE',{body:d.body||'',icon:'./icon-192.png',badge:'./icon-badge.png',tag:d.tag||'vantage-index',renotify:true,data:d.url||'./'}));
});
self.addEventListener('notificationclick',e=>{
  e.notification.close();const target=e.notification.data||'./';
